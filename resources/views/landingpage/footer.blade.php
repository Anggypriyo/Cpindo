<footer>
	<div class="row m-0" style="background-color: #964B00;">
		...
		<div class="col-xl-4 py-4 px-4 align-middle text-white">
			...
			<!-- Copyright <a href="{{url('/admin')}}">&copy; </a>2022 <br>Warung Pindo<br> All Rights Reserved -->
			Warung Pindo
            <br>Jl. Ketapang - Suko No.17, Dusun Ketapang, Suko, Kecamatan Sidoarjo, Kabupaten Sidoarjo, Jawa Timur
		</div>
	</div>
</footer>