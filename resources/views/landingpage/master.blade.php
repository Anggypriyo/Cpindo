		...
		<div class="container-fluid px-0" style="max-width: 100%;">
		  <div class="collapse navbar-collapse" id="navbarTogglerDemo02">
		    <ul class="navbar-nav mr-auto">
				...
				<li class="nav-item  py-2 visiMisi mx-3">
					<a class="nav-link " href="#visi-misi">Visi dan Misi</a>
				</li>
				<li class="nav-item  py-2 struktur mx-3">
					<a class="nav-link " href="#struktur">Struktur Organisasi</a>
				</li>
				
				<li class="nav-item  py-2 denah mx-3">
					<a class="nav-link " href="#kawasan">Denah Kawasan</a>
				</li>
				<li class="nav-item dropdown py-2 dokumentasi mx-3">
		        <a class="nav-link dropdown-toggle" href="#dokumentasi" id="navbarDropdownMenuLink" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
		          Dokumentasi
		        </a>
		        <div class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
		          <a class="dropdown-item sejarah" href="{{url('/5R')}}" style="height:50px;">Dokumentasi 5R</a>
		          <a class="dropdown-item tujuan" href="{{url('/dokumentasi-foto')}}" style="height:50px">Dokumentasi Foto</a>
		          <a class="dropdown-item karakteristik" href="{{url('/dokumentasi-video')}}" style="height:50px">Dokumentasi Video</a>
                </div>
		      </li>
		    </ul>
		  	</div>
